...
<div align=center>![](02_opengl_es/opengles-cpu-gpu-m.png)</div>
...
<div align=center>![](02_opengl_es/opengles-all-process.png)</div>
...
#### 图形渲染管线的具体实现可分为六个阶段
<div align=center>![着色器在渲染管线中的使用](02_opengl_es/openglse-shader.png)</div>
...
<div align=center>![](02_opengl_es/openglse-ndc.png)</div>
...
<div align=center>![](02_opengl_es/opengles-vao.png)</div>
...
<div align=center>![](02_opengl_es/opengles-vap.png)</div>
...
```
下图为通过图：
<div align=center>![](02_opengl_es/opengles-ebo.png)</div>
...
<div align=center>![](02_opengl_es/opengles-vao_ebo.png)</div>
...
```
以下为三者的坐标系：
<div align=center>![](02_opengl_es/opengles-coord1.png)</div>

当我们直接把解析出来的数据（图：坐着电脑前的人）直接使用在 "OpenGL纹理坐标" 上，就会上下颠倒了，如下：
<div align=center>![](02_opengl_es/opengles-coord2.png)</div>

正确姿势如下（看"计算机图像纹理坐标"和"OpenGL物体表面坐标"对应的坐标与图像的变化）：
<div align=center>![](02_opengl_es/opengles-coord3.png)</div>
