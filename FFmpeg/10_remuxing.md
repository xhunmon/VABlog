...
本文来自官方例子`doc/examples/remuxing.c` 。
...
重新封装的原理就是把输入文件 [解封装](./08_demuxing.md) 之后，再进行 [封装](./09_muxing.md) 输出到新的文件中。
...
int main(int argc, char **argv) {
    ...
    in_filename = "source/Kobe.flv";
    out_filename = "output/Kobe.mp4";
