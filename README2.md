...
![音视频处理过程](https://xhunmon.github.io/VABlog/styles/va_program.jpg)
...
- [直播推流全过程：总纲](https://xhunmon.github.io/VABlog/RTMP/README)
- [直播推流全过程：视频数据源之YUV](https://xhunmon.github.io/VABlog/RTMP/1-yuv)
- [直播推流全过程：音频数据源之PCM](https://xhunmon.github.io/VABlog/RTMP/2-pcm)
- [直播推流全过程：视频编码之H.264](https://xhunmon.github.io/VABlog/RTMP/3-h264)
- [直播推流全过程：音频编码之AAC](https://xhunmon.github.io/VABlog/RTMP/4-aac)
- [直播推流全过程：直播推流编码之RTMP](https://xhunmon.github.io/VABlog/RTMP/5-rtmp)
- [其他：H.264符号描述](https://xhunmon.github.io/VABlog/RTMP/h264-descriptor)
- [其他：直播优化基础](https://xhunmon.github.io/VABlog/RTMP/6-optimize)

### 3.3.播放器小项目

此过程，体现从1~0。与3.2正好相反，把封装的文件(网络数据)通过解封装和解码，得到原始的裸数据（一帧帧图片）进行播放。

- [AFPlayer项目](https://xhunmon.github.io/VABlog/AFPlayer/README) Android实现FFmpeg、OpenSL ES、OpenGL SE、MediaCodec等，实现简单的播放器，主要体现出相关知识点的使用。
...
| ffprobe     | ffmpeg中自带的分析工具，非常强大，不过上手有难度。    |[参考](https://xhunmon.github.io/VABlog/FFmpeg/18_command)|
...
- [FFmpeg 中文文档](https://github.com/leandromoreira/ffmpeg-libav-tutorial/blob/master/README-cn)
- 书籍（电子书往最后翻）
...
#### 1.2.1.源码编译
[编译ffmpeg4.2.2](https://xhunmon.github.io/VABlog/FFmpeg/03_build_ffmpeg)通过这篇文章我们基本可以编译出我们想要的FFmpeg库

#### 1.2.2.源码阅读
- 源码导入：[FFmpeg导入到Clion（MacOS）](https://xhunmon.github.io/VABlog/FFmpeg/04_import_ffmpeg) 、 [使用Clion阅读FFmpeg源码（支持跳转）](https://xhunmon.github.io/VABlog/FFmpeg/05_source) 
...
#### 1.2.3.学习官方例子
- [FFmpeg重要结构体（转载）](https://xhunmon.github.io/VABlog/FFmpeg/06_struct) ，因为在学习FFmpeg中，必须得知道结构体中重要参数的含义，否则举步维艰。
- [FFmpeg Demuxing（解封装）](https://xhunmon.github.io/VABlog/FFmpeg/08_demuxing) 对应 `doc/examples/demuxing_decoding.c` 中的解封装部分。 
- [FFmpeg Muxing（封装）](https://xhunmon.github.io/VABlog/FFmpeg/09_muxing) 对应 `doc/examples/muxing.c` 。
- [FFmpeg Remuxing（重新封装）](https://xhunmon.github.io/VABlog/FFmpeg/10_remuxing) 对应 `doc/examples/remuxing.c` 。
- [FFmpeg Decode（解码）](https://xhunmon.github.io/VABlog/FFmpeg/11_decode) 对应 `doc/examples/decode_audio.c` 和 `doc/examples/decode_video.c` 。
- [FFmpeg Encode（编码）](https://xhunmon.github.io/VABlog/FFmpeg/12_encode) 对应 `doc/examples/encode_audio.c` 和 `doc/examples/encode_video.c` 。
- [FFmpeg 简单实现转码](https://xhunmon.github.io/VABlog/FFmpeg/13_transfer) 汇总解封装、解码、编码、封装放到一起方便理解 。
- [FFmpeg Filter和SDL（Video）](https://xhunmon.github.io/VABlog/FFmpeg/14_filter_v) 对应 `doc/examples/filtering_video.c` 。
- [FFmpeg Filter和SDL（Audio）](https://xhunmon.github.io/VABlog/FFmpeg/15_filter_a) 对应 `doc/examples/filtering_video.c` 。
- [FFmpeg Transcode(转码)](https://xhunmon.github.io/VABlog/FFmpeg/16_transcode) 对应 `doc/examples/transcoding.c` 。
- [FFmpeg Swscale（图像转换）](https://xhunmon.github.io/VABlog/FFmpeg/19_swscale) 对应 `doc/examples/scaling_video.c` 。

#### 1.2.4.音视频同步
- [FFmpeg 音视频同步处理](https://xhunmon.github.io/VABlog/FFmpeg/17_sync)

#### 1.2.5.FFmpeg相关
- [FFmpeg 命令使用指南：分析ffmpeg、ffprobe、ffplay工具使用文档，关联官方文档，以及滤镜、协议、视频合并、各种播放参数等相关介绍](https://xhunmon.github.io/VABlog/FFmpeg/18_command)
...
- [OpenGL基础知识](https://xhunmon.github.io/VABlog/OpenGL/01_opengl)
- [GLSL（着色器语言）中文手册](https://xhunmon.github.io/VABlog/OpenGL/02_glsl)
- [AFPlayer：OpenGL ES播放RGB](https://xhunmon.github.io/VABlog/AFPlayer/02_opengl_es)
...
- [面试题整理：祝君拿到满意的offer！](https://xhunmon.github.io/VABlog/MustRead/03_fst)
